...
<div class="form-group">
    <label class="col-md-2 control-label">被查看数据机构</label>
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'bhid', CHtml::listData(HospitalExt::model()->findAll(),'id','name'), array('class' => 'form-control select2', 'encode' => false,'empty'=>'请选择')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'bhid') ?></div>
</div>
<div class="form-actions">
    <div class="row">
        <div class="col-md-offset-3 col-md-9">
            <button type="submit" class="btn green">保存</button>
            <?php echo CHtml::link('返回',$this->createUrl('applylist',['pid'=>$pid,'hid'=>$hid]), array('class' => 'btn default')) ?>
        </div>
    </div>
</div>
