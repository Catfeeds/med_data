...
<div class="form-group">
    <label class="col-md-2 control-label">内容名</label>
    <div class="col-md-6">
...
<div class="form-group">
    ...
    <div class="col-md-6">
       <?php echo $form->dropDownList($article, 'tid', CHtml::listData(BasicTagExt::model()->findAll(),'id','op'), array('class' => 'form-control select2', 'encode' => false,'empty'=>'请选择')); ?><span class="help-block">类型请选择内置标签</span>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-2"><a class="btn blue " onclick="showmore()"><i class="fa fa-plus"> 更多选项</i></a><?php echo $form->error($article, 's1') ?></div>
</div>
<div id="showmore" style="display: none">
    <?php foreach (range(2, 10) as $key) {?>
    <?php $n = 'n'.$key;$s = 's'.$key;$t = 't'.$key;$o = 'o'.$key;?>
        <div class="form-group">
            <label class="col-md-2 control-label">选项类型<span class="required" aria-required="true">*</span></label>
            <div class="col-md-6">
...
<div class="form-actions">
    <div class="row">
        <div class="col-md-offset-3 col-md-9">
            ...
            <?php echo CHtml::link('返回',$this->createUrl('taglist',['mid'=>$mid]), array('class' => 'btn default')) ?>
        </div>
    </div>
</div>
