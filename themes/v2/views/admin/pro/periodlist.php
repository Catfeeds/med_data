...
<div class="table-toolbar">
    <div class="btn-group pull-left">
        <form class="form-inline">
            <div class="form-group">
                <?php echo CHtml::dropDownList('type',$type,array('title'=>'阶段名'),array('class'=>'form-control','encode'=>false)); ?>
            </div>
            <div class="form-group">
    ...
    <div class="pull-right">
        <a href="<?php echo $this->createAbsoluteUrl('periodedit',['pid'=>$pid]) ?>" class="btn blue">
            添加阶段 <i class="fa fa-plus"></i>
        </a>
    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td style="text-align:center;vertical-align: middle">
                <a href="<?php echo $this->createUrl('modulelist',array('cate'=>$v->id,'pid'=>$pid)); ?>" class="btn default btn-xs grey"> 模块设计 </a>
                <a href="<?php echo $this->createUrl('periodedit',array('ppid'=>$v->id,'pid'=>$pid)); ?>" class="btn default btn-xs blue"> 复制阶段内容 </a>
                <a href="<?php echo $this->createUrl('periodedit',array('id'=>$v->id,'pid'=>$pid)); ?>" class="btn default btn-xs green"><i class="fa fa-edit"></i> 修改 </a>
