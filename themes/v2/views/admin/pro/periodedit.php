...
<div class="form-group">
    <label class="col-md-2 control-label">阶段名<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
...
<div class="form-actions">
    <div class="row">
        <div class="col-md-offset-3 col-md-9">
            ...
            <?php echo CHtml::link('返回',$this->createUrl('periodlist',['pid'=>$info->id]), array('class' => 'btn default')) ?>
        </div>
    </div>
</div>
