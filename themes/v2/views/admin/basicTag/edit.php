...
<div class="form-group">
    <label class="col-md-2 control-label">检验项目类别</label>
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'cid', CHtml::listData(TagExt::model()->normal()->findAll('cate="jymk"'),'id','name'), array('class' => 'form-control select2', 'encode' => false,'empty'=>'请选择')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'cid') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">输入检测名称<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
...
<div class="form-group">
    <label class="col-md-2 control-label">输入测定项目<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
...
<div class="form-group">
    <label class="col-md-2 control-label">输入单位<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
        <?php echo $form->textField($article, 'unit', array('class' => 'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'unit') ?><span class="help-inline">多个用空格隔开</span></div>
</div>
<div class="form-group">
