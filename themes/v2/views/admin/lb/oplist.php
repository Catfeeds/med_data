...
<div class="table-toolbar">
    ...
    <div class="pull-right">
        ...
        <a href="<?php echo $this->createAbsoluteUrl('opedit',['lid'=>$lid]) ?>" class="btn blue">
            添加选项 <i class="fa fa-plus"></i>
        </a>
    </div>
</div>
   <table class="table table-bordered table-striped table-condensed flip-content table-hover">
    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td class="text-center"><?=$v->o?></td>
            <td class="text-center"><?=$v->type?Yii::app()->params['tags'][$v->type]:'-'?></td>
            <td class="text-center"><?=date('Y-m-d',$v->created)?></td>
            <td class="text-center"><?=date('Y-m-d',$v->updated)?></td>
            <td style="text-align:center;vertical-align: middle">
                <a href="<?php echo $this->createUrl('opedit',array('id'=>$v->id,'lid'=>$lid)); ?>" class="btn default btn-xs green"><i class="fa fa-edit"></i> 修改 </a>
