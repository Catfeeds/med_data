   ...
   <table class="table table-bordered table-striped table-condensed flip-content table-hover">
    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td class="text-center"><?=$v->is_admin?'管理员':($v->hospital?$v->hospital->name:'')?></td> 
            <td class="text-center"><?=$v->is_admin?'管理员':($v->user?$v->user->name:'')?></td> 
            <td class="text-center"><?=$v->getObj()?$v->getObj()->no:''?></td> 
