...
<div class="form-group">
    <label class="col-md-2 control-label">申请理由<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
...
<div class="form-actions">
    <div class="row">
        <div class="col-md-offset-3 col-md-9">
            ...
            <?php echo CHtml::link('返回',$this->createUrl('ilist',['pid'=>$ill->pid]), array('class' => 'btn default')) ?>
        </div>
    </div>
</div>
<?php $this->endWidget() ?>
